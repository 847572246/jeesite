...
MyLayer.prototype.openLayer = function () {
  ...
  background_layer.style.backgroundColor = "gray";//提示框外围背景颜色
  background_layer.style.zIndex = "1001";
  background_layer.style.opacity = "0.8" ;//提示框外围背景颜色透明的
  ...
  open_layer.style.backgroundColor = "white";//内容背景颜色
  ...
  div_toolBar.style.backgroundColor = "aliceblue";//标题颜色
  div_toolBar.style.height = "40px";
  var span_title = document.createElement("span");
  span_title.style.fontSize = "30px";//标题字体大小
  span_title.style.color = "red" ;//标题字体颜色
  ...
  span_close.style.fontSize = "16px";//关闭字体大小
  ...
  var div_content = document.createElement("div");//内容
  div_content.style.fontSize="50px";
  ...
  var div_content1 = document.createElement("div");//内容
  div_content1.style.fontSize="50px";
    div_content1.style.color="red";
  div_content1.style.textAlign = "center";
  var content1_area = document.createTextNode(this.options.content1 === undefined ? "" : this.options.content1);
  div_content1.appendChild(content1_area);
  open_layer.appendChild(div_content1);
  document.body.appendChild(open_layer);
  document.body.appendChild(background_layer);
  open_layer.style.display = "block" ;
  background_layer.style.display = "block";
  
  var div_content2 = document.createElement("div");//内容
  div_content2.style.fontSize="30px";
  div_content2.style.textAlign = "center";
  var content2_area = document.createTextNode(this.options.content2 === undefined ? "" : this.options.content2);
  div_content2.appendChild(content2_area);
  open_layer.appendChild(div_content2);
  document.body.appendChild(open_layer);
  document.body.appendChild(background_layer);
  open_layer.style.display = "block" ;
  background_layer.style.display = "block";
  
  var div_content3 = document.createElement("div");//内容
  div_content3.style.fontSize="30px";
  div_content3.style.textAlign = "center";
  var content3_area = document.createTextNode(this.options.content3 === undefined ? "" : this.options.content3);
  div_content3.appendChild(content3_area);
  open_layer.appendChild(div_content3);
  document.body.appendChild(open_layer);
  document.body.appendChild(background_layer);
  open_layer.style.display = "block" ;
  background_layer.style.display = "block";
