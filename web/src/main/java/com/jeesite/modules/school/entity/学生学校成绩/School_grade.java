 ...
 */
package com.jeesite.modules.school.entity.学生学校成绩;
 ...
 * @version 2018-12-20
 */
@Table(name="school_grade", alias="a", columns={
...
public class School_grade extends DataEntity<School_grade> {
