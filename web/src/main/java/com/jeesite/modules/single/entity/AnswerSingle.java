...
@Table(name="single_selection", alias="a", columns={
        ...
        @Column(name="wrong_reason_id", attrName="wrongReasonId", label="知识点号"),
        @Column(name="wrong_reason", attrName="wrongReason", label="知识点"),
		@Column(includeEntity=DataEntity.class),
	}, orderBy="a.update_date DESC"
)
public class AnswerSingle extends DataEntity<AnswerSingle> {
    ...
    private String wrongReasonId;		// 知识点号
    private String wrongReason;		// 知识点

	public AnswerSingle() {
		this(null);
	}

	public AnswerSingle(String id){
		super(id);
	}
